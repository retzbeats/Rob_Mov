/*
 * gesture_ligth_sensor.h
 *
 * Created: 05/04/2015 12:30:11 p.m.
 *  Author: Nick
 */ 


#ifndef GESTURE_LIGTH_SENSOR_H_
#define GESTURE_LIGTH_SENSOR_H_

#include "OctoPlus/OctoPlus.h"


/*TWI Port Used*/
#define TWI_PORT_AD &TWIE	
...
int disableProximitySensor(void);
...
int setAmbientLightGain(uint8_t gain);
uint8_t getProximityGain(void);
int setProximityGain(uint8_t gain);
